...
exports.default = {
    username: {
        ...
        custom: {
            ...
            options: function (username) { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, userService.isUserExists(username)];
                        case 1:
                            if (_a.sent()) {
                ...
                return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                console.log("KEK");
                                return [4 /*yield*/, authService.comparePasswords(req.body.username, password)];
                            case 1:
                                if (_b.sent()) {
                                    return [2 /*return*/, Promise.resolve()];
                                }
