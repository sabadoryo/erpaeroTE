...
exports.default = {
    id: {
        ...
        custom: {
            ...
            options: function (tagId) { return __awaiter(void 0, void 0, void 0, function () {
                var tag;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, tagService.getTagById(tagId)];
                        case 1:
                            tag = _a.sent();
                            if (tag) {
    ...
    taskId: {
        custom: {
            errorMessage: "Provided task doesn't exist",
            options: function (taskId, _a) {
                var req = _a.req;
                return __awaiter(void 0, void 0, void 0, function () {
                    var task;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0: return [4 /*yield*/, taskService.getTaskById(taskId)];
                            case 1:
                                task = _b.sent();
                                if (task) {
                                    return [2 /*return*/, Promise.resolve()];
